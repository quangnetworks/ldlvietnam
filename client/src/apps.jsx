...
export const ECOSYSTEM = [
  ...
  { key: 'message', name: 'Base Message', desc: 'Chat nhóm', cat: 'platform', icon: MessageCircle, color: '#1098ad', path: '/message', module: 'message' },
  { key: 'drive', name: 'Base Drive', desc: 'Tài liệu', cat: 'platform', icon: FolderOpen, color: '#f59f00', path: '/drive', module: 'drive' },
  ...
  { key: 'hrm', name: 'Base HRM', desc: 'Nhân sự', cat: 'hrm', icon: Users2, color: '#e03131', path: '/hrm', module: 'hrm' },
  { key: 'payroll', name: 'Base Payroll', desc: 'Tính lương', cat: 'hrm', icon: Wallet, color: '#2b8a3e' },
  { key: 'checkin', name: 'Base Checkin', desc: 'Chấm công', cat: 'hrm', icon: Fingerprint, color: '#f76707', path: '/checkin', module: 'checkin' },
  { key: 'timeoff', name: 'Base Timeoff', desc: 'Nghỉ phép và vắng mặt', cat: 'hrm', icon: Plane, color: '#15aabf', path: '/timeoff', module: 'timeoff' },
