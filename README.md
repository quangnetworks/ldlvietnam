...
- Dự án & phòng ban: tạo mới / từ **mẫu**, lưu dự án thành mẫu, thành viên & vai trò, **nhóm công việc** (mọi thành viên tạo được ngay trong danh sách, Kanban, khi tạo / sửa công việc; quản lý dự án đổi tên / xoá);
